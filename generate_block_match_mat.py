...
n1 = 8    # Block edge
n2 = 8   # Number of similar blocks to look for
ns = 7   # Search neighbourhood edge
...
scipy.io.savemat('block_match_results', {'mt':mt, 'ref':ref, 'ns':ns,
                                         'nstep':nstep, 'n1':n1, 'n2':n2,
                                         'y': y})
